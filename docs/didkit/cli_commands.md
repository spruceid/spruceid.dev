...
Options are the same as for [vc-issue-credential](#vc-issue-credential).
...
Options and output format are the same as for [vc-verify-credential](#vc-verify-credential).
